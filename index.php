...
<section id="Kelas">
  ...
  <div class="row text-center mb-3">
          <div class="col"><h2 class="text-white">Kelas</h2></div>
     </div>
...
?>      
  ...
  <img src="img/<?php echo $Kelas['f_nama']?>.jpg" class="card-img-top" height="150" alt="<?php echo $Kelas['f_nama']?>">
  <div class="card-body">
...
<section id="Jurusan">
 ...
 <div class="row text-center mb-3">
          <div class="col"><h2 class="text-white">Jurusan</h2></div>
        </div>
 <div class="row justify-content-center">
...
<div class="card " style="width: 18rem;">
  <img src="img/<?php echo $value['f_nama'];?>.jpg" height="150" class="card-img-top" alt="jurusan">
  <div class="card-body">
    <h5 class="card-title">
...
<!-- guru -->
  ...
  <div class="container"> 
  <div class="row text-center mb-3">
          <div class="col"><h2 class="text-white">Guru</h2></div>
     </div>
     <div class="row justify-content-center">
     <?php
...
<section id="siswa">
<div class="row text-center mb-3">
          <div class="col"><h2 class="text-white">Siswa</h2></div>
     </div>
